...
public class Blogpost {
    ...
    public String toString() {
        return "Blogpost{" +
                "_id='" + id + '\'' +
                ", blogpost_album_1_rank='" + blogpost_album_1_rank + '\'' +
                ", blogpost_album_2_rank='" + blogpost_album_2_rank + '\'' +
                ", blogpost_title='" + blogpost_title + '\'' +
                ", blogpost_intro='" + blogpost_intro + '\'' +
                ", blogpost_review_1='" + blogpost_review_1 + '\'' +
                ", blogpost_review_2='" + blogpost_review_2 + '\'' +
                ", blogpost_hero_photo='" + blogpost_hero_photo + '\'' +
                ", blogpost_hero_photo_caption='" + blogpost_hero_photo_caption + '\'' +
                ", blogpost_album_art_1='" + blogpost_album_art_1 + '\'' +
                ", blogpost_album_art_2='" + blogpost_album_art_2 + '\'' +
                ", blogpost_album_art_1_details='" + blogpost_album_art_1_details + '\'' +
                ", blogpost_album_art_2_details='" + blogpost_album_art_2_details + '\'' +
                ", blogpost_map='" + blogpost_map + '\'' +
                ", blogpost_map_details='" + blogpost_map_details + '\'' +
                ", blogpost_coulda_shoulda_album_art_1='" + blogpost_coulda_shoulda_album_art_1 + '\'' +
                ", blogpost_coulda_shoulda_album_art_2='" + blogpost_coulda_shoulda_album_art_2 + '\'' +
                ", blogpost_coulda_shoulda_1_details='" + blogpost_coulda_shoulda_1_details + '\'' +
                ", blogpost_coulda_shoulda_2_details='" + blogpost_coulda_shoulda_2_details + '\'' +
                ", createdAt='" + createdAt + '\'' +
                ", updatedAt='" + updatedAt + '\'' +
                '}';
    }
