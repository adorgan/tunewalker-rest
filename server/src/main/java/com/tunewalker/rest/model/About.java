...
public class About {
    ...
    public About(String id, String blogpost_title, String blogpost_intro, String blogpost_hero_photo, String blogpost_hero_photo_caption, String blogpost_map, String createdAt, String updatedAt) {
        this.id = id;
