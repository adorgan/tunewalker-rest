...
import com.tunewalker.rest.dto.StudentDTO;
import com.tunewalker.rest.model.Student;
import com.tunewalker.rest.service.BlogpostService;
import com.tunewalker.rest.service.StudentService;
...
public class StudentRestController {
    ...
    public List<BlogpostDTO> getAllBlogposts() {
        return ObjectMapperUtils.mapAll(blogpostService.findAll(), BlogpostDTO.class);
    }
